...
export const Badge = ({ variant, text, children, className, ...props }) => {
  const styles = {
    ...
    md: 'bg-accent text-accent-foreground text-sm font-sans py-1 px-3 rounded-lg shadow-[0_0_90px_0px_rgba(0,255,255,0.2)]  duration-500 hover:bg-muted-foreground/20',
  }
  return (
